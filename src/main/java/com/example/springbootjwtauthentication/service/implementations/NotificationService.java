...
public class NotificationService {
    ...
    public void notifyTransporter(Order order, Transporter transporter) throws FirebaseMessagingException {
        ...
        Message msg = Message.builder()
                ...
                .putData("orderCost", Double.toString(order.getOrderCost()))
                .putData("orderWeight", Double.toString(order.getOrderWeight()))
                .putData("orderVolume", Double.toString(order.getOrderVolume()))
                .putData("estimatedTravelDistance", Double.toString(order.getEstimatedTravelDistance()))
                .putData("estimatedTravelDuration", Double.toString(order.getEstimatedTravelDuration()))
                .putData("customerName", order.getCustomer().getCompleteName())
                .putData("producerName", order.getProducer().getCompleteName())
                .putData("customerAddress", order.getProducer().getCurrentAddress().getAddressResume())
                .putData("producerAddress", order.getProducer().getCurrentAddress().getAddressResume())
