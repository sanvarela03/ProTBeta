...
import com.example.springbootjwtauthentication.controller.service.interfaces.ResetPassword;
...
public class ResetPasswordJwt implements ResetPassword {
    private static final Logger logger = LoggerFactory.getLogger(ResetPasswordJwt.class);
